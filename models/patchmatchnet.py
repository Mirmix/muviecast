...
class PatchmatchNet(nn.Module):
    ...
    def forward(
        ...
        score_patchmatch: Dict[int, List[torch.Tensor]] = {}
        ...
        if to_evaluate == False:
            return depth_patchmatch
        score_patchmatch[0] = [score]
        if to_evaluate==False:
            return depth_patchmatch, score_patchmatch
        if self.training:
            ...
            return depth, score, photometric_confidence, depth_patchmatch
